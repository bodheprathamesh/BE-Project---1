...
final_dataset = tuple(zip(distinct_names_list,money_foryear_perperson_transpose[0],money_foryear_perperson_transpose[1],money_foryear_perperson_transpose[2],money_foryear_perperson_transpose[3],money_foryear_perperson_transpose[4],money_foryear_perperson_transpose[5],money_foryear_perperson_transpose[6],money_foryear_perperson_transpose[7],money_foryear_perperson_transpose[8],money_foryear_perperson_transpose[9],money_foryear_perperson_transpose[10],money_foryear_perperson_transpose[11],age,gender,transactions_count,money_foryear_perperson_transpose[13],money_foryear_perperson_transpose[14],money_foryear_perperson_transpose[15],money_foryear_perperson_transpose[16],money_foryear_perperson_transpose[17], money_foryear_perperson_transpose[12]))

df = pd.DataFrame(final_dataset)

df.columns =['Name', 'Jan', 'Feb', 'Mar', 'Apr', 'May', 'Jun', 'Jul','Aug', 'Sept', 'Oct', 'Nov', 'Dec', 'Age', 'Gender', 'TransactionCount', 'Duration', 'Peak Season', 'Before Season months', 'Months left for End of Season','AVG Sales', 'Loan Amount']
